...
export const Hero = () => {
  return (
    <Section className="flex max-md:flex-col-reverse items-start gap-4">
      <div
        id="presentation"
        className="flex-[3] w-full flex flex-col gap-2 max-md:items-center"
      >
        ...
        <p className="max-md:text-justify">
          Après douze ans dans le commerce, j&apos;ai choisi de suivre une
          formation de développeur front-end. Cette décision est motivée par mon
          envie de relever de nouveaux défis et de me spécialiser dans les
          technologies numériques pour créer des interfaces utilisateur
